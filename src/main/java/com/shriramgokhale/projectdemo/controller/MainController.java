...
public class MainController {
    ...
    public String welcomePage(Model model) {
        ...
        model.addAttribute("message", "Welcome to Daily Essentials!");
        return "welcomePage";
    }
    ...
    public String adminPage(Model model, Principal principal) {
        ...
        List<Sales> sales = appSalesDAO.getSales();
    ...
    @RequestMapping("/newSalesPage")
    public String showNewSalesPage(Model model) {
